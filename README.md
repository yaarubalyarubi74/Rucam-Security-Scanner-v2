Rukamco Network Security Scanner
Project Overview
This project, "Designing, Implementing and Securing the Network Infrastructure with Vulnerability Scanning for Rukamco LLC", provides a comprehensive network vulnerability assessment tool. Developed under the supervision of Muhammad Sohail Hayat, this application enables IT administrators to identify and document network vulnerabilities, ensuring a secure infrastructure for Rukamco LLC.

Features
Automated Scanning: Utilizes the nmap library to perform network vulnerability scans.

GUI Dashboard: Features a user-friendly interface for simplified security management.

Automated Reporting: Generates a scan_report.txt file for detailed vulnerability auditing.

Secure Versioning: Managed via Git to maintain code integrity and provide an audit trail for development.
here are the codes i have used to criate the aaplication:
